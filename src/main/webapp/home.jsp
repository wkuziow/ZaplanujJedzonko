            ...
            <div class="col-5">
                <div class="input-group mb-3">
                    ...
                    <div class="input-group-append">
                        <button class="input-group-text btn-color border-0 rounded-0" type="submit" id="basic-addon3"> <%--tutaj wyskakiwał error, teraz ta sekcja jest zupełnie zgodnie z index.html--%>
